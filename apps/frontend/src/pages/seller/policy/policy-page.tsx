        ...
        <div className="space-y-12">
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                <h2 className="font-bold text-2xl text-indigo-700 mb-4 border-b border-indigo-100 pb-2">
                ...
                <div className="mt-4 bg-indigo-50 p-4 rounded-lg">
                  <p className="text-sm text-indigo-800">
                    <strong>Pro Tip:</strong> Include clear photos from multiple
                    angles and detailed descriptions of your products to
                    demonstrate authenticity and build buyer trust.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="mt-6 bg-gray-50 rounded-lg overflow-hidden">
                  <div className="px-4 py-3 bg-gray-100 text-xs font-semibold text-gray-700">
                  ...
                  <div className="p-4">
                    ...
                    <div className="ml-4 w-px h-6 bg-indigo-200"></div>
                    <div className="flex items-center">
                    ...
                    <div className="ml-4 w-px h-6 bg-indigo-200"></div>
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-indigo-400 text-white flex items-center justify-center text-sm font-bold">
                        3
                      </div>
                      <div className="ml-3 mr-1 flex-grow">
                        <p className="text-sm font-medium">
                    ...
                    <div className="ml-4 w-px h-6 bg-indigo-200"></div>
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-indigo-300 text-white flex items-center justify-center text-sm font-bold">
                        4
                      </div>
                      <div className="ml-3 mr-1 flex-grow">
              ...
              <div>
                ...
                <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-center bg-red-50 px-3 py-2 rounded-lg"
                    >
              ...
              <div>
                ...
                <div className="mt-4 p-4 border-l-4 border-yellow-400 bg-yellow-50">
                  <p className="text-sm text-yellow-800">
                    <strong>Important:</strong> While you can politely request
                    customers to leave honest reviews, offering compensation or
                    incentives for positive reviews violates our policies.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-indigo-50 py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button className="px-6 py-3 bg-white text-indigo-600 border border-indigo-200 rounded-lg hover:bg-indigo-50 transition-colors shadow-md">
              View FAQ
            </button>
          </div>
        </div>
